...
def generate_substructures(input_file, create_files):
   ...
   # for line in all_lines[0:5]:
    ...
    if create_files == 'y':
        ...
        multiple_molecules.save('/mnt/scratch/stokm006/generate_substructures/filter/official/permutation_7_structures.png')       
    ...
    if create_files == 'y':
        ...
        with open("permutation_7_substructures.txt", 'w') as db_file:
        ...
        multiple_molecules.save('/mnt/scratch/stokm006/generate_substructures/filter/official/permutation_7_substructures.png')       
    ...
    for key, values in filter1_dict.items():
        ...
        for smile in values:
            if smile != '<NA>':
                ...
                if nr_of_hetero_atoms >= 1:    # adjust this value
...
def filter5(structure_info, filter4_dict, draw_substructures):
                ...
                for smile in values:
                    if smile != '<NA>':
                        ...
                        if input_mol.HasSubstructMatch(sub_mol) == True:
                            ...
                            if min_nr_of_bonds <= 3:    # adjust this value
    ...
    with open("final_permutation_7_substructures.txt", 'w') as db_file:
