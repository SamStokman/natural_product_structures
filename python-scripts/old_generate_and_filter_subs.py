...
def generate_substructures(input_file, create_files):
   ...
   # for line in all_lines[:-1]:
    ...
    if create_files == 'y':
       ...
       multiple_molecules.save('/mnt/scratch/stokm006/generate_substructures/filter/official/test1_structures.png')       
        ...
        for env in mol_env_list:
            ...
            if sub_smile != '' and sub_smile != structure_smile:
                ...
                try:
                    ...
                    if sub_smile not in valid_sub_list:
    ...
    if create_files == 'y':
        ...
        with open("test2_old2_substructures1.txt", 'w') as db_file:
        ...
        multiple_molecules.save('/mnt/scratch/stokm006/generate_substructures/filter/official/test3_old2_substructures.png')       
...
def filter5(structure_info, filter4_dict, draw_substructures):
    ...
    with open("test4_substructures.txt", 'w') as db_file:
    ...
    if draw_substructures == 'y':
        # To draw all_substructures       
        multiple_molecules = Draw.MolsToGridImage(draw_list, molsPerRow=5,subImgSize=(250,150), legends = draw_legend_list)
        multiple_molecules.save('/mnt/scratch/stokm006/generate_substructures/filter/official/test5_substructures.png')       
